NOTE: my 'original' assignment was to implement A3C, but I did not have time to start on this. Therefore, my assignment became an implementation of DQN and its asynchronous variant.
